...
namespace Admin.Controllers
{
    public class SikayetsController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Subject,Aciklama,Date,UserId")] Sikayet sikayet)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Subject,Aciklama,Date,UserId")] Sikayet sikayet)
        {
            if (ModelState.IsValid)
            {
