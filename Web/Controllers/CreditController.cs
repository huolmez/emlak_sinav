...
namespace Web.Controllers
{
    ...
    public class CreditController : BaseController
    {
        ...
        {
            Project project = emlakmvc.ProjectSet.FirstOrDefault(q => q.Id == Id);
            ...
            if (ModelState.IsValid)
            {
                ...
                emlakmvc.PaymentSet.Add(payment);
        ...
        public ActionResult List()
        {
            ...
            var payments = emlakmvc.PaymentSet.Where(q => q.UserId == UserId).AsEnumerable();
